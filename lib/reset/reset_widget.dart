...
class _ResetWidgetState extends State<ResetWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Reset'});
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: InkWell(
                          onTap: () async {
                            logFirebaseEvent('RESET_PAGE_Row_ddjzrtsy_ON_TAP');
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'RESET_PAGE_ZURÜCKSETZEN_BTN_ON_TAP');
                          ...
                          Row(
                            ...
                            children: [
                              InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'RESET_PAGE_Container_6imi96hu_ON_TAP');
