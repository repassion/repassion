...
import 'passion_edit_model.dart';
export 'passion_edit_model.dart';

class PassionEditWidget extends StatefulWidget {
  const PassionEditWidget({
    Key? key,
    this.passion,
  }) : super(key: key);
  ...
  @override
  _PassionEditWidgetState createState() => _PassionEditWidgetState();
}

class _PassionEditWidgetState extends State<PassionEditWidget> {
  late PassionEditModel _model;
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.beschreibungController1 ??=
                                                  TextEditingController(
                                            text: mainUserPassionRecord
                                                .description,
                                          ),
                                          ...
                                          minLines: 1,
                                          validator: _model
                                              .beschreibungController1Validator
                                              .asValidator(context),
                                        ),
                                      ),
                                      Padding(
                                                                ...
                                                                builder:
                                                                  ...
                                                                  return AlertDialog(
                                                                    title: Text(
                                                                        'Bild löschen'),
                                                                    content: Text(
                                                                        'Möchtest du das Bild wirklich entfernen?'),
                                                                    actions: [
                                                                      TextButton(
                                      ...
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.beschreibungController2,
                                          autofillHints: [
                                            AutofillHints.organizationName
                                          ],
                                          textCapitalization:
                                          ...
                                          minLines: 1,
                                          validator: _model
                                              .beschreibungController2Validator
                                              .asValidator(context),
                                        ),
                                      ),
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.beschreibungController3 ??=
                                                  TextEditingController(
                                            text: mainUserPassionRecord.text,
                                          ),
                                          autofillHints: [
                                            AutofillHints.organizationName
                                          ],
                                          ...
                                          minLines: 1,
                                          validator: _model
                                              .beschreibungController3Validator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ],
                              ...
                              onTap: () async {
                                ...
                                if (!mainUserPassionRecord.none!) {
                                  ...
                                  final passionUpdateData2 = {
                                    ...createPassionRecordData(
                                      title: _model.titelController.text,
                                      description:
                                  ...
                                  if (_model.beschreibungController2.text !=
                                    ...
                                    final passionUpdateData3 =
                                        createPassionRecordData(
                                      video:
                                          _model.beschreibungController2.text,
                                    );
                                    await mainUserPassionRecord.reference
                                        .update(passionUpdateData3);
                                  }
                                  ...
                                  final passionCreateData = {
                                    ...createPassionRecordData(
                                      ...
                                      title: _model.titelController.text,
                                      description:
                                          _model.beschreibungController1.text,
                                      text: _model.beschreibungController3.text,
                                      type: _model.dropDownValue,
                                      image: _model.uploadedFileUrl,
                                  ...
                                  await PassionRecord.collection
                                      .doc()
