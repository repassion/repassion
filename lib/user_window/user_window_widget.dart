                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          if (mainUserUserRecord.info != null &&
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final tags =
                                        mainUserUserRecord.tags!.toList();
                                    return Wrap(
                                      spacing: 5.0,
                                      runSpacing: 5.0,
                                      alignment: WrapAlignment.start,
                                      ...
                                      children: List.generate(tags.length,
                                        ...
                                        return StreamBuilder<TagRecord>(
                                          stream:
                                              TagRecord.getDocument(tagsItem),
                                          builder: (context, snapshot) {
                                            // Customize what your widget looks like when it's loading.
                                            if (!snapshot.hasData) {
                                              return Center(
                                            ...
                                            final containerTagRecord =
                                                snapshot.data!;
                                            return Container(
                                              decoration: BoxDecoration(
                                                color:
                                                    containerTagRecord.colour,
                                                borderRadius:
