...
class HomeWidget extends StatefulWidget {
  ...
  final List<DocumentReference>? tagsSelected;
                              ...
                              InkWell(
                                onTap: () async {
                                  final requestCreateData = {
                                    ...createRequestRecordData(
                                      uid1: currentUserReference,
                                      uid2: swipeableStackUserRecordList[index]!
                                          .reference,
                                      status: 'blocked',
                                    ),
                                  ...
                                  final userUpdateData1 = {
                                    'requests': FieldValue.arrayUnion([
                                      swipeableStackUserRecordList[index]!.uid
                                    ]),
                                  };
                                  await currentUserReference!
                                  ...
                                  await swipeableStackUserRecordList[index]!
                                      .reference
