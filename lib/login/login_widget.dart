                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: InkWell(
                          onTap: () async {
                            logFirebaseEvent('LOGIN_PAGE_Row_41j9rf4m_ON_TAP');
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'LOGIN_PAGE_ANMELDEN_BTN_ON_TAP');
                                        logFirebaseEvent(
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'LOGIN_PAGE_Text_1ox570g0_ON_TAP');
                                ...
                                InkWell(
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'LOGIN_PAGE_Text_669ugpjq_ON_TAP');
                                    logFirebaseEvent('Text_navigate_to');
                          ...
                          Row(
                            ...
                            children: [
                              InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'LOGIN_PAGE_Container_afbmuv2p_ON_TAP');
