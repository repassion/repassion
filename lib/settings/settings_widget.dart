                                                                ...
                                                                children: [
                                                                  AuthUserStreamWidget(
                                                                    builder:
                                                                        (context) =>
                                                                            AutoSizeText(
                                                                      '${valueOrDefault(currentUserDocument?.firstName, '')} ${valueOrDefault(currentUserDocument?.lastName, '')} (${functions.getAge(valueOrDefault(currentUserDocument?.birthdate, '')).toString()})',
                                                                      maxLines:
                                                                          2,
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      valueOrDefault<
                                                                          String>(
                                                                        functions.getLocation(valueOrDefault(
                                                                            currentUserDocument?.locationAddress,
                                                                            '')),
                                                                  ...
                                                                  Padding(
                                                                    padding: EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                    child: Text(
                                                                      'Gestalte Profil und Informationen',
                                                                      textAlign:
                                                                          TextAlign
                                                                              .start,
                                                                      style: FlutterFlowTheme.of(
                                                    ...
                                                    onChanged:
                                                      ...
                                                      if (newValue!) {
                                                        logFirebaseEvent(
                                                            'SETTINGS_PAGE_startupSwitch_ON_TOGGLE_ON');
                                                        logFirebaseEvent(
                                                            'startupSwitch_set_dark_mode_settings');
                                                        setDarkModeSetting(
                                                            context,
                                                            ThemeMode.dark);
                                                        logFirebaseEvent(
                                                                  ...
                                                                  Padding(
                                                                    padding: EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                    child: Text(
                                                                      'Verwalte deinen repassion Account',
                                                                      textAlign:
                                                                          TextAlign
                                                                              .start,
                                                                      style: FlutterFlowTheme.of(
                                                              ...
                                                              builder:
                                                                ...
                                                                return AlertDialog(
                                                                  title: Text(
                                                                      'Ausloggen'),
                                                                  content: Text(
                                                                      'Möchtest du dich aus deinem Konto ausloggen?'),
                                                                  actions: [
                                                                    TextButton(
                                                                  ...
                                                                  Padding(
                                                                    padding: EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                    child: Text(
                                                                      'Logge dich aus deinem Account aus',
                                                                      textAlign:
                                                                          TextAlign
                                                                              .start,
                                                                      style: FlutterFlowTheme.of(
                                                              ...
                                                              builder:
                                                                ...
                                                                return AlertDialog(
                                                                  title: Text(
                                                                      'Account löschen'),
                                                                  content: Text(
                                                                      'Soll dein Konto inklusiver all deiner Daten unwiderruflich gelöscht werden?'),
                                                                  actions: [
                                                                    TextButton(
                                                                      onPressed: () => Navigator.pop(
                                                                          alertDialogContext,
                                                                  ...
                                                                  Padding(
                                                                    padding: EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                    child: Text(
                                                                      'Entferne alle Daten deines Accounts',
                                                                      textAlign:
                                                                          TextAlign
                                                                              .start,
                                                                      style: FlutterFlowTheme.of(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    await launchURL('https://repassion.de/');
                                  },
                                  child: Row(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
