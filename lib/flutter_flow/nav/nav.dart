          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => HomeWidget(
                tagsSelected: params.getParam<DocumentReference>(
                    'tagsSelected', ParamType.DocumentReference, true, ['tag']),
                allTags:
                    params.getParam<String>('allTags', ParamType.String, true),
              ),
            ),
            FFRoute(
              name: 'Chat',
            ...
            FFRoute(
              ...
              builder: (context, params) => ChatWindowWidget(
                chat: params.getParam(
                    'chat', ParamType.DocumentReference, false, ['chat']),
              ),
            ),
            FFRoute(
              name: 'UserWindow',
